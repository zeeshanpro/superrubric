          ...
          <div class="row collapse" id="criteria_detail_1">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_131" id="txt_131" value="" onKeyUp="return setTextToDiv('131');">Lack of reflection. Unclear and difficult to understand ideas.
          ...
          <div class="row collapse" id="criteria_detail_2">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_311" id="txt_311" value="" onKeyUp="return setTextToDiv('311');">Lack of connections. Writer has some ideas but do not have clear descriptions. 
                </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_3">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_461" id="txt_461" value="" onKeyUp="return setTextToDiv('461');"> Very high degree of errors in sentence structure and word usage makes writing difficult to understand. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_611" id="txt_611" value="" onKeyUp="return setTextToDiv('611');">Very limited use of academic, transition, and descriptive words. Sentences repeat the same words frequently. 
                </textarea>
                </div>
              </div>
            </div>
          ...
          <table class="table table-bordered school-table">
            ...
            <tbody>
              ...
              <tr class="main_criteria_1">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_131">Lack of reflection. Unclear and difficult to understand ideas.
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_13">Lack of reflection. Unclear and difficult to understand ideas.<br><br>Keywords: matches, retells, selects, quotes, lists</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_18">Moderate reflection. Explains underlying theme, indicating good understanding. <br><br>Keywords: articulates, determines, inferrs, summarizes, questions, explains</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_23">Superb reflection. Demonstrates understanding by defending ideas and using multiple perspectives.<br><br>Keywords: reflects, defends, debates, predicts, solves</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_2">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_311">Lack of connections. Writer has some ideas but do not have clear descriptions.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_31">Surface connections. Writer demonstrates a difficulty creating depth in explanation. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_35">Logical connections. Uses multiple sources to connect beyond reading and/or personal experience.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_39">Thick connections. Thorough use of outside sources creates depth and meaning to response.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_3">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_461">Very high degree of errors in sentence structure and word usage makes writing difficult to understand.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_46">Frequent and severe errors in grammar, sentence structure and word usage.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_50">Limited errors in grammar, sentence structure and word usage. Content is easy to read. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_54">No errors in grammar, sentence structure and word usage. Creative use of language provides a thick, narrative description of content and themes. </p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_4">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_611">Very limited use of academic, transition, and descriptive words. Sentences repeat the same words frequently.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_61">Entry contains limited use of vocabulary. Few academic, transition, and descriptive words are used. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_65">Entry contains moderate use of vocabulary. Academic, transition, and descriptive words are used at grade level. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_69">Entry contains excellent use of vocabulary. Academic, transition, and descriptive words are used to create a storytelling experience. </p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_5">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_84">No errors in formatting and references. Writer uses references to strengthen content and develop themes.</p>
                  </div>
                  <ul>

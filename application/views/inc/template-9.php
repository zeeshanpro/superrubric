            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
				<div class="from-field">
					<div class="form-group">
						<span> CRITERIA </span>
						<input type="text" class="form-control" name="txt_11" id="txt_11" value="CONTENT & FOCUS" onKeyUp="return setTextToDiv('11');">
					</div>
				</div>
			</div> 
			...
			<div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">	
					<div class="form-group">
						...
						<textarea class="form-control" rows="4" name="txt_13" id="txt_13" value="" onKeyUp="return setTextToDiv('13');">Limited depth of content. Focus of research is not clear.
...
Keywords: identifies, indicates, recalls, records, tells, repeats</textarea>
			...
			<div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">		
					<div class="form-group">
						<span>ACHIEVING</span>
						<textarea class="form-control" rows="4" name="txt_18" id="txt_18" value="" onKeyUp="return setTextToDiv('18');">Moderate depth of content. Writer develops focus of research with little divergence. 
                
Keywords: compares, describes, expresses, explains, examines, organizes</textarea>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">			
					<div class="form-group">
						<span>MASTERING</span>
						<textarea class="form-control" rows="4" name="txt_23" id="txt_23" value="" onKeyUp="return setTextToDiv('23');">Thick description. Detailed content with clear research topic. Does not diverge.
                
Keywords: persuades, validates, critiques, argues, animates, supports, integrates</textarea>
					</div>
				</div>
			</div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
				<div class="from-field">	
				  <div class="form-group">
						<span>CRITERIA</span>
						<input type="text" class="form-control" name="txt_29" id="txt_29" value="PURPOSE INTEGRATION" onKeyUp="return setTextToDiv('29');">
				  </div>
				</div>
            </div>
        <div class="col-sm-6 col-md-6 col-lg-2">	
		...
		<div class="row collapse" id="criteria_detail_2">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">
					<div class="form-group">
						<span>DEVELOPING</span>
						<textarea class="form-control" rows="4" name="txt_31" id="txt_31" value="" onKeyUp="return setTextToDiv('31');">Lack of coherent themes. Purpose is unclear and inconsistent.
...
Keywords: matches, retells, selects, quotes, lists </textarea>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">
					<div class="form-group">
						<span>ACHIEVING</span>
						<textarea class="form-control" rows="4" name="txt_35" id="txt_35" value="" onKeyUp="return setTextToDiv('35');">Appropriate organization. Satisfying articulation of purpose with some deviation. 
...
Keywords: articulates, determines, inferrs, summarizes, questions, explains</textarea>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">
					<div class="form-group">
						<span>MASTERING</span>
						<textarea class="form-control" rows="4" name="txt_39" id="txt_39" value="" onKeyUp="return setTextToDiv('39');">Logical, structured and readily apparent ideas create clear themes and purpose.
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <div class="from-field">
				<div class="form-group">
					<span>CRITERIA</span>
					<input type="text" class="form-control" name="txt_44" id="txt_44" value="FORMATTING & REFERENCES" onKeyUp="return setTextToDiv('44');">
                </div>
              </div>  
            </div>
                    <div class="col-sm-6 col-md-6 col-lg-2">
		...
		<div class="row collapse" id="criteria_detail_3">   
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
				<div class="form-group">
					<span>DEVELOPING</span>
					<textarea class="form-control" rows="4" name="txt_46" id="txt_46" value="" onKeyUp="return setTextToDiv('46');">Frequent or severe errors in formatting. Uses and cites some sources.</textarea>
				</div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
				<div class="form-group">
					<span>ACHIEVING</span>
					<textarea class="form-control" rows="4" name="txt_50" id="txt_50" value="" onKeyUp="return setTextToDiv('50');">Limited errors in formatting and references. Writer cites sources with accuracy.</textarea>
				</div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				<div class="from-field">	
					<div class="form-group">
						<span>MASTERING</span>
						<textarea class="form-control" rows="4" name="txt_54" id="txt_54" value="" onKeyUp="return setTextToDiv('54');">No errors in formatting and references. Writer uses references to strengthen content and develop themes.</textarea>
					</div>
				</div>
			</div>
            ...
            <div class="table-section">
              <table class="table table-bordered school-table">
                ...
                <tbody>
                  <!--Box 1--->
                  <tr>
                    <th class="bg-gry" scope="row"><span id="txtdiv_11"> CONTENT & FOCUS</span>
                    ...
                    <td><div class="pd5"><p id="txtdiv_13">Limited depth of content. Focus of research is not clear.<br><br>Keywords: identifies, indicates, recalls, records, tells, repeats</p></div>
                      <ul>
                        <li class="criteria_1" id="txtdiv_20">C-</li>
                        <li class="criteria_1" id="txtdiv_21">C</li>
                        <li class="criteria_1" id="txtdiv_22">C+</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_18">Moderate depth of content. Writer develops focus of research with little divergence. <br><br>Keywords: compares, describes, expresses, explains, examines, organizes </p>
                    </div>
                      <ul>
                    ...
                    <td><div class="pd5"><p id="txtdiv_23">Thick description. Detailed content with clear research topic. Does not diverge.<br><br>Keywords: persuades, validates, critiques, argues, animates, supports, integrates</p></div>
                      <ul>
                  ...
                  <!--Box 2--->
                  <tr>
                    <th class="bg-gry" scope="row"><span id="txtdiv_29"> PURPOSE INTEGRATION</span>
                    ...
                    <td><div class="pd5"><p id="txtdiv_31">Lack of coherent themes. Purpose is unclear and inconsistent. <br><br>Keywords: matches, retells, selects, quotes, lists  </p></div>
                      <ul>
                        <li class="criteria_2" id="txtdiv_36">C-</li>
                        <li class="criteria_2" id="txtdiv_37">C</li>
                        <li class="criteria_2" id="txtdiv_38">C+</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_35">Appropriate organization. Satisfying articulation of purpose with some deviation. <br><br>Keywords: articulates, determines, inferrs, summarizes, questions, explains</p></div>
                      <ul>
                        <li class="criteria_2" id="txtdiv_40">B-</li>
                        <li class="criteria_2" id="txtdiv_41">B</li>
                        <li class="criteria_2" id="txtdiv_42">B+</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_39">Logical, structured and readily apparent ideas create clear themes and purpose. <br><br>Keywords: reflects, defends, debates, predicts, solves.</p></div>
                      <ul>
                  ...
                  <!--Box 3--->
                  <tr>
                    <th class="bg-gry" scope="row"><span id="txtdiv_44">FORMATTING & REFERENCES </span>
                    ...
                    <td><div class="pd5"><p id="txtdiv_46">Frequent or severe errors in formatting. Uses and cites some sources.</p></div>
                      <ul>
                        <li class="criteria_3" id="txtdiv_51">C-</li>
                        <li class="criteria_3" id="txtdiv_52">C</li>
                        <li class="criteria_3" id="txtdiv_53">C+</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_50">Limited errors in formatting and references. Writer cites sources with accuracy.</p></div>
                      <ul>
                        <li class="criteria_3" id="txtdiv_55">B-</li>
                        <li class="criteria_3" id="txtdiv_56">B</li>
                        <li class="criteria_3" id="txtdiv_57">B+</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_54">No errors in formatting and references. Writer uses references to strengthen content and develop themes.</p></div>
                      <ul>

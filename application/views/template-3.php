          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_29" id="txt_29" value="THEMATIC ORGANIZATION & THESIS" onKeyUp="return setTextToDiv('29');">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-2">
          ...
          <div class="row collapse" id="criteria_detail_2">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_31" id="txt_31" value="" onKeyUp="return setTextToDiv('31');">Lack of coherent themes. Unclear and difficult to understand thesis.
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-2">
              <div class="from-field">
                <div class="form-group">
                  <span>% Value</span>
                  <input type="text" class="form-control" name="txt_45" id="txt_45" value="15%" onKeyUp="return setTextToDiv('45');" onblur="calculateScore('45','58')">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4">
        ...
        <div class="main_criteria_5">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_74" id="txt_74" value="PERSPECTIVE" onKeyUp="return setTextToDiv('74');">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-2">
          ...
          <div class="row collapse" id="criteria_detail_5">
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_761" id="txt_761" value="" onKeyUp="return setTextToDiv('761');">Writing is limited in depth. Limited effort made to create unique and persuasive work.
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              ...
              <div class="from-field">
                <div class="form-group"><span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_76" id="txt_76" value="" onKeyUp="return setTextToDiv('76');">Writing is limited in depth. Limited effort made to create unique and persuasive work that creates a new understanding of topic. </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_80" id="txt_80" value="" onKeyUp="return setTextToDiv('80');">Writer displays good understanding for rhetoric and helps reader to understand unique perspectives drawn from critical thinking. </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_84" id="txt_84" value="" onKeyUp="return setTextToDiv('84');">Writer creates a thick description that leads to mastery-level writing. Perspective is clear, planned, and leads to discovery. </textarea>
                </div>
              </div>
            </div>
          ...
          <table class="table table-bordered school-table">
            ...
            <tbody>
              ...
              <tr class="main_criteria_1">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_13">Limited depth of content. Clarity of writing needs development.<br><br>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_18">Moderate depth of content. Writing demonstrates good clarity.</br><br> Keywords: compares, describes, expresses, explains, examines, organizes</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_23">Thick description. Detailed content provides very good clarity.<br><br>Keywords: persuades, validates, critiques, argues, animates, supports, integrates.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_2">
                <th class="bg-gry" scope="row"><span id="txtdiv_29">THEMATIC ORGANIZATION & THESIS</span>
                  <p id="txtdiv_30">20%</p>
                </th>
                <td>
                  <div class="pd5">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_31">Lack of coherent themes. Unclear and difficult to understand thesis.<br><br>Keywords: matches, retells, selects, quotes, lists</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_5">
                <th class="bg-gry" scope="row"><span id="txtdiv_74">PERSPECTIVE</span>
                  <p id="txtdiv_75">10%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_761">Writing is limited in depth. Limited effort made to create unique and persuasive work.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_76">Writing is limited in depth. Limited effort made to create unique and persuasive work that creates a new understanding of topic. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_80">Writer displays good understanding for rhetoric and helps reader to understand unique perspectives drawn from critical thinking. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_84">Writer creates a thick description that leads to mastery-level writing. Perspective is clear, planned, and leads to discovery. </p>
                  </div>
                  <ul>

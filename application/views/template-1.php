            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_11" id="txt_11" value="CREATIVITY" onKeyUp="return setTextToDiv('11');">
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_1">
              ...
              <div class="from-field">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="txt_131" id="txt_131" value="" onKeyUp="return setTextToDiv('131');">
						      Very little effort made to develop unique work. Student is copying design elements. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="txt_13" id="txt_13" value="" onKeyUp="return setTextToDiv('13');">Limited use of imagination or original ideas. Student shows limited ability to transcend simple design elements.
                Keywords: copies, recalls, discovers, retells
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_18" id="txt_18" value="" onKeyUp="return setTextToDiv('18');">Moderate use of imagination. Student shows good ability to create new methods, ideas, and interpretations.
                  Keywords: expresses,  organizes, reflects, experiments
                              </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_23" id="txt_23" value="" onKeyUp="return setTextToDiv('23');">Detailed imagination is evident. High-level ability to create, design, and transcend traditional works.
                  Keywords: invents, animates, publishes, structures
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_29" id="txt_29" value="USE OF ARTISTIC ELEMENTS/ APPLICATION OF METHODS" onKeyUp="return setTextToDiv('29');">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-2">
          ...
          <div class="row collapse" id="criteria_detail_2">
              ...
              <div class="from-field">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="txt_311" id="txt_311" value="" onKeyUp="return setTextToDiv('311');">BEGINNING Details
                            ...
                            Limited ability to follow application of methods. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_31" id="txt_31" value="" onKeyUp="return setTextToDiv('31');">Moderate ability to follow application of methods. .
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_35" id="txt_35" value="" onKeyUp="return setTextToDiv('35');">Good ability to follow methods and instruction. Student shows initiative to utilize advanced methods. 
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_39" id="txt_39" value="" onKeyUp="return setTextToDiv('39');">Student has mastered the described methods. Use of artistic elements is detailed and extensively used in works.
                </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_44" id="txt_44" value="CRAFTSMANSHIP & DETAIL" onKeyUp="return setTextToDiv('44');">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-2">
          ...
          <div class="row collapse" id="criteria_detail_3">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_461" id="txt_461" value="" onKeyUp="return setTextToDiv('461');"> Limited techniques used to develop detail, consistency, and balance in works. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_46" id="txt_46" value="" onKeyUp="return setTextToDiv('46');">Moderate techniques used to develop detail, consistency, and balance in works. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_50" id="txt_50" value="" onKeyUp="return setTextToDiv('50');">Good use of techniques. Detail provides balance, consistency and creates expression in works. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_54" id="txt_54" value="" onKeyUp="return setTextToDiv('54');">Profound use of techniques and detail create unique work that inspire and enrich the recipient. 
                  </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_59" id="txt_59" value="ONGOING STUDENT SELF-ASSESSMENT" onKeyUp="return setTextToDiv('59');">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_611" id="txt_611" value="" onKeyUp="return setTextToDiv('611');">I did not actively use my class time wisely. 
                </textarea>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_61" id="txt_61" value="" onKeyUp="return setTextToDiv('61');">I use some of my time wisely.
                I did not collaborate well with others. 
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_65" id="txt_65" value="" onKeyUp="return setTextToDiv('65');">I used my class time effectively. I was able to create new ideas by collaborating with other students,  
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_69" id="txt_69" value="" onKeyUp="return setTextToDiv('69');">I used my class time very effectively. By collaborating with others I was able to create unique and detailed work. 
                </textarea>
                </div>
              </div>
            </div>
        ...
        <div class="main_criteria_5">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="from-field">
                <div class="form-group">
                  <span>Criteria</span>
                  <input type="text" class="form-control" name="txt_74" id="txt_74" value="OVERALL STUDENT SELF-ASSESSMENT" onKeyUp="return setTextToDiv('74');">
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-2">
          ...
          <div class="row collapse" id="criteria_detail_5">
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_761" id="txt_761" value="" onKeyUp="return setTextToDiv('761');">I am not proud of my final work. My work could use major improvements. 
                </textarea>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>DEVELOPING</span>
                  <textarea class="form-control" rows="4" name="txt_76" id="txt_76" value="" onKeyUp="return setTextToDiv('76');">I am somewhat proud of my final work. My work could use some improvement. .
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>ACHIEVING</span>
                  <textarea class="form-control" rows="4" name="txt_80" id="txt_80" value="" onKeyUp="return setTextToDiv('80');">I am proud of my final work. My work meets my expectations for this project.</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>MASTERING</span>
                  <textarea class="form-control" rows="4" name="txt_84" id="txt_84" value="" onKeyUp="return setTextToDiv('84');">I am very proud of my work. I believe my work is exceptional and could be a model for the next class.</textarea>
                </div>
              </div>
            </div>
...
<div class="right-panel show_left_panel">
  <div class="board">
    <div class="resume">
      <div class="btn-hover">
        <div class="download-btn" id="download_btn"> <?php echo $download_btn; ?>
        </div>
        <!--<button id="demo" class="downloadtable" onclick="downloadtable()"> Download Table</button>-->
      </div>
          ...
          <table class="table table-bordered school-table">
            ...
            <tbody>
              ...
              <tr class="main_criteria_1">
                <th class="bg-gry" scope="row"><span id="txtdiv_11">CREATIVITY</span>
                  <p id="txtdiv_12">20%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_131">Very little effort made to develop unique work. Student is copying design elements.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_13">Limited use of imagination or original ideas. Student shows limited ability to transcend simple design elements. <br><br>
                      Keywords: copies, recalls, discovers, retells</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_18">Moderate use of imagination. Student shows good ability to create new methods, ideas, and interpretations. </br><br> Keywords: expresses, organizes, reflects, experiments</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_23">Detailed imagination is evident. High-level ability to create, design, and transcend traditional works.<br><br>
                      Keywords: invents, animates, publishes, structures</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_2">
                <th class="bg-gry" scope="row"><span id="txtdiv_29">USE OF ARTISTIC ELEMENTS / APPLICATION OF METHODS</span>
                  <p id="txtdiv_30">20%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_311">Limited ability to follow application of methods. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_31">Limited ability to follow application of methods.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_35">Good ability to follow methods and instruction. Student shows initiative to utilize advanced methods. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_39">Student has mastered the described methods. Use of artistic elements is detailed and extensively used in works.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_3">
                <th class="bg-gry" scope="row"><span id="txtdiv_44">CRAFTSMANSHIP & DETAIL</span>
                  <p id="txtdiv_45">20%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_461">Limited techniques used to develop detail, consistency, and balance in works.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_46">Limited techniques used to develop detail, consistency, and balance in works</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_50">Good use of techniques. Detail provides balance, consistency and creates expression in works.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_54">Profound use of techniques and detail create unique work that inspire and enrich the recipient.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_4">
                <th class="bg-gry" scope="row"><span id="txtdiv_59">ONGOING STUDENT SELF-ASSESSMENT</span>
                  <p id="txtdiv_60">20%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_611">I did not actively use my class time wisely.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_61">I use some of my time wisely. I did not collaborate well with others.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_65">I used my class time effectively. I was able to create new ideas by collaborating with other students</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_69">I used my class time very effectively. By collaborating with others I was able to create unique and detailed work.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_5">
                <th class="bg-gry" scope="row"><span id="txtdiv_74">OVERALL STUDENT SELF-ASSESSMENT</span>
                  <p id="txtdiv_75">20%</p>
                </th>
                <td>
                  <div class="pd5">
                    <p id="txtdiv_761">I am not proud of my final work. My work could use major improvements.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_76">I am somewhat proud of my final work. My work could use some improvement.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_80">I am proud of my final work. My work meets my expectations for this project.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_84">I am very proud of my work. I believe my work is exceptional and could be a model for the next class.</p>
                  </div>
                  <ul>

          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
             ...
             <div class="from-field">
				<div class="form-group">
					<span>PERCENT VALUE</span>
					<input type="text" class="form-control" name="txt_45" id="txt_45" value="| 15%" onKeyUp="return setTextToDiv('45');">
				</div>
			 </div>
              ...
              <table class="table table-bordered school-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><div class="pd5"><p id="txtdiv_13">Limited depth of content. Clarity of writing needs development.<br><br>
                    ...
                    <td><div class="pd5"><p id="txtdiv_18">Moderate depth of content. Writing demonstrates good clarity.</br><br> Keywords: compares, describes, expresses, explains, examines, organizes</p>
                    </div>
                      <ul>
                    ...
                    <td><div class="pd5"><p id="txtdiv_23">Thick description. Detailed content provides very good clarity.<br><br>Keywords: persuades, validates, critiques, argues, animates, supports, integrates.</p></div>
                      <ul>
                  ...
                  <tr>
                    ...
                    <td><div class="pd5"><p id="txtdiv_31">Lack of coherent themes. Unclear and difficult to understand thesis.<br><br>Keywords: matches, retells, selects, quotes, lists</p></div>
                      <ul>
                  ...
                  <tr>
                    ...
                    <td><div class="pd5"><p id="txtdiv_76">Writing is limited in depth. Limited effort made to create unique and persuasive work that creates a new understanding of topic. </p></div>
                      <ul>
                        <li class="criteria_5" id="txtdiv_77">1</li>
                        <li class="criteria_5" id="txtdiv_78">2</li>
                        <li class="criteria_5" id="txtdiv_79">3</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_80">Writer displays good understanding for rhetoric and helps reader to understand unique perspectives drawn from critical thinking. </p></div>
                      <ul>
                        <li class="criteria_5" id="txtdiv_81">4</li>
                        <li class="criteria_5" id="txtdiv_82">5</li>
                        <li class="criteria_5" id="txtdiv_83">6</li>
                      </ul></td>
                    <td><div class="pd5"><p id="txtdiv_84">Writer creates a thick description that leads to mastery-level writing. Perspective is clear, planned, and leads to discovery. </p></div>
                      <ul>

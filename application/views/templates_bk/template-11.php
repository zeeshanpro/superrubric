            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				...
				<div class="from-field">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="txt_12" id="txt_12" value="" onKeyUp="return setTextToDiv('12');">
					</div>
				 </div>
				 <div class="from-field">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				...
				<div class="from-field">
					<div class="form-group">
						<span>PERCENT VALUE</span>
						<input type="text" class="form-control" name="txt_30" id="txt_30" value="" onKeyUp="return setTextToDiv('30');">
					</div>
				 </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
             ...
             <div class="from-field">
				<div class="form-group">
					<span>PERCENT VALUE</span>
					<input type="text" class="form-control" name="txt_45" id="txt_45" value="" onKeyUp="return setTextToDiv('45');">
				</div>
			 </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				...
				<div class="from-field">
					<div class="form-group">
						<span>PERCENT VALUE</span>
						<input type="text" class="form-control" name="txt_60" id="txt_60" value="" onKeyUp="return setTextToDiv('60');">
					</div>
				</div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
				...
				<div class="from-field">
					<div class="form-group">
						<span>PERCENT VALUE</span>
						<input type="text" class="form-control" name="txt_75" id="txt_75" value="" onKeyUp="return setTextToDiv('75');">
					</div>
				</div>

          ...
          <div class="row collapse" id="criteria_detail_1">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_131" id="txt_131" value="" onKeyUp="return setTextToDiv('131');">Limited ability to substitute, combine or express terms. With strong assistance, the student is capable of 1-2 step problems. 
                  </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_2">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_311" id="txt_311" value="" onKeyUp="return setTextToDiv('311');">Student shows difficulty understanding place value, number comparisons and basic 1-2 digit addition/subtraction.
              </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_3">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_461" id="txt_461" value="" onKeyUp="return setTextToDiv('461');"> Student demonstrates limited ability for shape identification and basic geometric equations.
                </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_611" id="txt_611" value="" onKeyUp="return setTextToDiv('611');">Limited ability to read and represent data. With assistance, student is developing the ability to calculate mean, median and mode.  
                </textarea>
                </div>
              </div>
            </div>
        ...
        <div class="main_criteria_5">
          ...
          <div class="row collapse" id="criteria_detail_5">
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group"><span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_761" id="txt_761" value="" onKeyUp="return setTextToDiv('761');">Life skills such as saving, budgeting, and investing have not been observed. Student shows difficulty with telling time and measurement. 
                </textarea>
                </div>
              </div>
            </div>
          ...
          <table class="table table-bordered school-table">
            ...
            <tbody>
              ...
              <tr class="main_criteria_1">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_131">Limited ability to substitute, combine or express terms. With strong assistance, the student is capable of 1-2 step problems.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_13">Limited ability to substitute, combine or express terms. With assistance, the student is capable of 1-2 step problems.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_18">Good ability to substitute, combine or express terms. Student is comfortable with 1-2 step problems and is progressing into equations that require adapted formulas.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_23">Exceptional ability to substitute, combine or express terms. Student is capable of manipulating a formula to solve a problem.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_2">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_311">Student shows difficulty understanding place value, number comparisons and basic 1-2 digit addition/subtraction.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_31">Student shows difficulty understanding place value, number comparisons and basic 1-2 digit addition/subtraction.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_35">Student is capable of understanding place value, number comparisons and basic 1-2 digit addition/subtraction. Student is able to multiply and divide using assistive technology.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_39">Student has a deep understanding of place value, number comparisons and numeration. Student is capable of word problems and regularly calculates 1-2 digit problems without assistive technology.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_3">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_461">Student demonstrates limited ability for shape identification and basic geometric equations.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_46">Student demonstrates limited ability for shape identification and basic geometric equations. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_50">Student demonstrates ability to understand angles and equations needed to solve geometric problems. Student is gaining the ability to manipulate an equation to solve.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_54">Detailed skills for geometry lead to complex problems and fast processing speeds. Student completes coursework with high accuracy and requires few prompts.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_4">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_611">Limited ability to read and represent data. With assistance, student is developing the ability to calculate mean, median and mode.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_61">Limited ability to read and represent data. Student is developing the ability to calculate mean, median and mode. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_65">Good ability to read and represent data. Student can calculate mean, median, and mode. Student is beginning to understand distributions, and deviations. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_69">A deep understanding for data and stats leads to concrete work with detailed graphs, plots, and representations. Student is able to understand what story the numbers tell. </p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_5">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_761">Life skills such as saving, budgeting, and investing have not been observed. Student shows difficulty with telling time and measurement.
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_76">Life skills such as saving, budgeting, and investing have not been observed. Student shows difficulty with telling time and measurement. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_80">Life skills such as saving, budgeting, and investing have been demonstrated. Student is capable of telling time, and understanding measurement. </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_84">Life skills such as saving, budgeting, and investing are clearly visible. Student is capable of telling time, and understanding measurement and uses them to better their education. </p>
                  </div>
                  <ul>

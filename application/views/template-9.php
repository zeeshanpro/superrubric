          ...
          <div class="row collapse" id="criteria_detail_1">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_131" id="txt_131" value="" onKeyUp="return setTextToDiv('131');">Limited depth of content. Focus of research is not clear.

                  Keywords: records, tells, repeats
                  </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_2">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING </span>
                  <textarea class="form-control" rows="4" name="txt_311" id="txt_311" value="" onKeyUp="return setTextToDiv('311');">Lack of coherent themes. Purpose is unclear and inconsistent.

                Keywords: matches, retells, lists
                </textarea>
                </div>
              </div>
            </div>
          ...
          <div class="row collapse" id="criteria_detail_3">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="from-field">
                <div class="form-group">
                  <span>BEGINNING</span>
                  <textarea class="form-control" rows="4" name="txt_461" id="txt_461" value="" onKeyUp="return setTextToDiv('461');"> High degree of errors in formatting. Student does not use references to support their work. .
                  </textarea>
                </div>
              </div>
            </div>
          ...
          <table class="table table-bordered school-table">
            ...
            <tbody>
              ...
              <tr class="main_criteria_1">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_131">Limited depth of content. Focus of research is not clear.
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_13">Limited depth of content. Focus of research is not clear.<br><br>Keywords: identifies, indicates, recalls, records, tells, repeats</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_18">Moderate depth of content. Writer develops focus of research with little divergence. <br><br>Keywords: compares, describes, expresses, explains, examines, organizes </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_23">Thick description. Detailed content with clear research topic. Does not diverge.<br><br>Keywords: persuades, validates, critiques, argues, animates, supports, integrates</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_2">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_311">Lack of coherent themes. Purpose is unclear and inconsistent.
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_31">Lack of coherent themes. Purpose is unclear and inconsistent. <br><br>Keywords: matches, retells, selects, quotes, lists </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_35">Appropriate organization. Satisfying articulation of purpose with some deviation. <br><br>Keywords: articulates, determines, inferrs, summarizes, questions, explains</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_39">Logical, structured and readily apparent ideas create clear themes and purpose. <br><br>Keywords: reflects, defends, debates, predicts, solves.</p>
                  </div>
                  <ul>
              ...
              <tr class="main_criteria_3">
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_461">High degree of errors in formatting. Student does not use references to support their work. .
                    </p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_46">Frequent or severe errors in formatting. Uses and cites some sources.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_50">Limited errors in formatting and references. Writer cites sources with accuracy.</p>
                  </div>
                  <ul>
                ...
                <td>
                  <div class="pd5">
                    <p id="txtdiv_54">No errors in formatting and references. Writer uses references to strengthen content and develop themes.</p>
                  </div>
                  <ul>
